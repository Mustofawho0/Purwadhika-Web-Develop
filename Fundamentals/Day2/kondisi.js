...
nilai >= 90
  ...
  : nilai >= 70
  ? console.log("Lulus")
  : console.log("Tidak Lulus"); // jika memiliki 3 kondisi
...
if (!input) {
  // pada syntax ini untuk mengetahui apakah sebuah nilai sudah terisi atau belum bisa di perhatikan pada tanda ("!") jika ada maka input belum terisi jika tidak ada maka input sudah terisi
  console.log("Input harus diisi");
} else {
  console.log("Input sudah terisi");
}
